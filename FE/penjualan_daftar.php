...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="position:fixed; margin-top:0%; width:100%">
  ...
  <center><p class="judul"> Record Penjualan </p></center>
    ...
    <div class="containerForm" style="padding: 8%; height: 100%;"> 
        ...
        <button class="addbtn">
          <a onclick="<?php $_SESSION ['page'] = 'read_pelanggan' ?>" href="penjualan_tambah.php">
            Tambah
          </a>
        </button>
          ...
          ?>
            ...
            <tr>
                ...
                <td class="btnaksi" style="padding: 0.5%;">
                    ...
                    <button type="button" title="Edit data" class="btn btn-warning" style="background-color: #DDEAD2; height:8mm; width:14mm" OnClick="return confirm('Yakin mau hapus transaksi nomor invoice <?php echo $show ['no_invoice']?>?\nSemua perubahan yang ada belum tersimpan!');">
                      <a href="/TB_PBD_B_KLP_7/BE/delete_transaksi.php?inv=<?php echo $show ['no_invoice']?>">
                      <i>
                        Hapus
                      </i>
                      </a>
