      ...
      <div class="row">
          ...
          <div class="col-75">
              <select class="form-select" name="barang" id="barang" for="barang" required aria-label="Default select example" >
                  <option disabled value="9" selected>--Pilih Barang--</option>
              <?php
                  ...
                  {
              ?> 
                  <option  value="<?php echo $show['id_barang']?>"><?php echo $show['nama_barang']?></option>
              <?php
                  }
              ?>
              </select>
              <small class="notif" style="margin-left:2%">*Tidak ada opsi payment method? tambah <a onclick="<?php $_SESSION['page'] = 'add_brg' ?>" href="/TB_PBD_B_KLP_7/FE/barang_tambah.php">di sini</a> </small>
            </div>
        </div>
        <div class="row">
          <div class="col-25">
        ...
        <div class="row">
          ...
          <div class="col-75">
            <input type="text" id="diskon" name="diskon" placeholder="Jumlah diskon" />
          </div>
        </div>
        <br />
        <div class="row">
