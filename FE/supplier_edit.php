...
$idsup=$_GET['id'];
$select = pg_query($connect, "SELECT * FROM tabel_supplier WHERE id_supplier = $idsup ");
...
<html lang="en">
  ...
  <body>
    ...
    <center><p class="judul">Edit Data Supplier</p></center>
    <div class="containerForm" style="padding: 8%; height: 15cm">
      <form method="POST" action="/tb_pbd_b_klp_7/BE/edit_supplier.php?id=<?php echo $idsup?>">
        <div class="row">
          <div class="col-25">
      ...
      <a  href="/TB_PBD_B_KLP_7/FE/supplier_daftar.php" style="text-decoration: none; hover:pointer;">
